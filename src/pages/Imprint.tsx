    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.innerContainer}>
                <div>
                    <h1 className={styles.title}>Impressum - Draft</h1><p>Angaben gemäß § 5 TMG</p><p>Max Muster <br/>
                    Musterweg<br/>
                    12345 Musterstadt <br/>
                </p>
                    <p><strong className={styles.subHeader}>Vertreten durch: </strong><br/>
                        Max Muster<br/>
                        Lisa Muster<br/>
                    </p>
                    <p><strong className={styles.subHeader}>Kontakt: </strong><br/>
                        Telefon: 01234-789456<br/>
                        Fax: 1234-56789<br/>
                        E-Mail: <a href='mailto:max@muster.de'>max@muster.de</a>
                        <br/></p>
                    <p><strong className={styles.subHeader}>Haftungsausschluss:</strong>
                        ...
                        Soweit
                        auf
                        unseren Seiten personenbezogene Daten (beispielsweise Name, Anschrift oder eMail-Adressen)
                        erhoben
                        ...
                        (''Google'').
                        Google Adsense verwendet sog. ''Cookies'' (Textdateien), die auf Ihrem Computer
                        gespeichert werden
                        und die eine Analyse der Benutzung der Website durch Sie ermöglicht. Google Adsense
                        verwendet auch
                        sog. ''Web Beacons'' (kleine unsichtbare Grafiken) zur Sammlung von Informationen. Durch
                        die
                        Verwendung des Web Beacons können einfache Aktionen wie der Besucherverkehr auf der
                        Webseite
                        ...
                        anderen
                        Daten der Google in Verbindung bringen. Das Speichern von Cookies auf Ihrer Festplatte
                        und die
                        Anzeige von Web Beacons können Sie verhindern, indem Sie in Ihren Browser-Einstellungen
                        ''keine
                        Cookies akzeptieren'' wählen (Im MS Internet-Explorer unter ''Extras {'>'} Internetoptionen
                        {'>'}
                        Datenschutz {'>'} Einstellung''; im Firefox unter
