    ...
    return (
        <div>
            ...
            <div className={styles.body}>
                ...
                Diensten und Inhalten, die in eine Webseite eingebunden werden, gehören. In solchen Fall beachten wir
                die
                ...
                kann. Zu
                diesen Zwecken können wir Infrastruktur- und Plattformdienstleistungen, Rechenkapazität, Speicherplatz
                und
                ...
                <h2 id="m17">Newsletter und elektronische Benachrichtigungen</h2><p>Wir versenden Newsletter, E-Mails
                und
                ...
                <p><strong>Double-Opt-In-Verfahren:</strong>
                    ...
                    in
                    einem sogenannte Double-Opt-In-Verfahren. D.h., Sie erhalten nach der Anmeldung eine E-Mail, in der
                    Sie
                    um die Bestätigung Ihrer Anmeldung gebeten werden. Diese Bestätigung ist notwendig, damit sich
                    niemand
                    mit fremden E-Mail-Adressen anmelden kann. Die Anmeldungen zum Newsletter werden protokolliert, um
                    den
                ...
                <p><strong>Hinweise zu Rechtsgrundlagen:</strong>
                    ...
                    beauftragen, geschieht dies auf der Grundlage unserer berechtigten Interessen an einem effizienten
                    und
                    sicheren Versand. Das Registrierungsverfahren wird auf der Grundlage unserer berechtigten Interessen
                    aufgezeichnet, um nachzuweisen, dass es in Übereinstimmung mit dem Gesetz durchgeführt wurde.</p>
                ...
                <ul className="m-elements">
                    <li><strong>Messung von Öffnungs- und Klickraten: </strong>
                        ...
                        IP-Adresse bestimmbar sind) oder der Zugriffszeiten genutzt. Diese Analyse beinhaltet ebenfalls
                        die
                        Feststellung, ob die Newsletter geöffnet werden, wann sie geöffnet werden und TODO here is text
                        missing
                    </li>
                </ul>
                <h2 id="m408">Umfragen und Befragungen</h2><p>
                Die von uns durchgeführten Umfragen und Befragungen
                (nachfolgend "Befragungen") werden anonym ausgewertet. Eine Verarbeitung personenbezogener Daten erfolgt
                ...
                <p><strong>Hinweise zu Rechtsgrundlagen:</strong>
                    ...
                    Verarbeitung ihrer Daten bitten, ist diese Rechtsgrundlage der Verarbeitung, ansonsten erfolgt die
