...
export const PrivacyStatement = () => {
  return (
    <>
      <StickyLegalHeader text="unser.datenschutz()" />
      <main className={styles.legalBackground}>
        <div className={styles.legalContainer}>
          ...
          <LegalSection header="Übersicht der Verarbeitungen">
            ...
            <p>
              <strong>Arten der verarbeiteten Daten: </strong> Bestandsdaten,
            ...
            <p>
              ...
              Direktmarketing, Bereitstellung unseres Onlineangebotes und
          ...
          <LegalSection header="Newsletter und elektronische Benachrichtigungen">
            ...
            <p>
              <strong>Hinweise zu Rechtsgrundlagen:</strong> Der Versand der Newsletter erfolgt
              auf Grundlage einer Einwilligung der Empfänger oder, falls eine
              Einwilligung nicht erforderlich ist, auf Grundlage unserer
              berechtigten Interessen am Direktmarketing, sofern und soweit
              diese gesetzlich, z.B. im Fall von Bestandskundenwerbung, erlaubt
              ist. Soweit wir einen Dienstleister mit dem Versand von E-Mails
            ...
            <p>
              ...
              zur Kündigung des Newsletters finden Sie entweder am Ende eines
            ...
            <p>
              <strong>Messung von Öffnungs- und Klickraten:</strong> Die Newsletter enthalten
              ...
              geöffnet werden, wann sie geöffnet werden und wo sie geöffnet
              werden.
            </p>
          </LegalSection>
          <LegalSection header="Umfragen und Befragungen">
            ...
            <p>
              ...
              Rechtsgrundlage der Verarbeitung, ansonsten erfolgt die
              Verarbeitung der Daten der Teilnehmer auf Grundlage unserer
              berechtigten Interessen an der Durchführung einer objektiven
              Umfrage.
            </p>
            <p>
